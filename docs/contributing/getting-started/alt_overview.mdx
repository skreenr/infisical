...
Infisical project encompasses two distinct codebases: one for the platform code, and one for the SDKs. The two codebases have differences in their contribution processes, please refer to the respective documentation sections below:

<CardGroup cols={2}>
  <Card title="Infisical Platform" href="/contributing/platform/developing" icon="layer-group" color="#A1B659">
    The Infisical platform is the core of the Infisical ecosystem. [link to google](https://google.com)

    * Github repository for  [Infisical Platform](https://github.com/Infisical/infisical)
  </Card>
  ...
  <Card href="/contributing/sdk/developing" title="Infisical SDK" icon="code" color="#A1B659">
    ...
    * Repository for  [Infisical SDK](https://github.com/Infisical/sdk)
  </Card>
</CardGroup>
