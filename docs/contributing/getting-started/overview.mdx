...
## Infisical Code-bases

Infisical project has two major code-bases: one for the platform code, and one for SDKs. The two code-bases have key differences in their contribution processes, please refer to respective documentation sections below :
...
* [Infisical SDK](https://github.com/Infisical/sdk) repository

* link to Github repository for [Infisical Platform](https://github.com/Infisical/infisical)

* Github link to [Infisical SDK](https://github.com/Infisical/sdk) repository
