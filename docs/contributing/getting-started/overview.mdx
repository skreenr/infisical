...
* Contributing to the [Infisical Platform](https://github.com/Infisical/infisical), the Infisical platform itself.

* Contributing to the [Infisical SDK](https://github.com/Infisical/sdk), the official Infisical client SDKs.
