...
Infisical has two major code-bases: one for the platform code, and one for SDKs. Contribution process has several key differences between the two, therefore we have split the documentation into two sections:

* Contributing to the [Infisical Platform](https://github.com/Infisical/infisical)

* Contributing to the [Infisical SDK](https://github.com/Infisical/sdk)
...
## Prerequisites and   for contributing
