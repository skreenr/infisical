...
Infisical has two major code-bases: one for the platform code, and one for SDKs. The two code-bases have key differences in their contribution processes, see the respective sections of the documentation:
...
* Repo for the [Infisical Platform](https://github.com/Infisical/infisical)

* [Infisical SDK](https://github.com/Infisical/sdk) repo
